...
## Placeholders
- Fill placeholders in the task line

## Task
Integrate {{EXTERNAL_API}} behind a server-side client with errors, timeouts, and env-based config.

## Constraints
- Search/reuse first
- Smallest correct diff
- Verify with tests or explicit manual steps
- Report changed files + verification + risks
